...
#ifndef PROTOCOL_PROTOCOL23W24_H_
#define PROTOCOL_PROTOCOL23W24_H_
...
RELIABLE_PACKET(Power_SupplyInfo,
	uint8_t bus_id; // 0: battery, 1: motors, 2: 5V, 3: 15V, 4: 24V, 5: 48V
	uint8_t state;  // 0: off, 1: switching, 2: supplying, 3: undervoltage, 4: overvoltage, 5: overcurrent, 6: vin too low, 7: vin too high, 8: DAC not found, 9: DAC fault
)

RELIABLE_PACKET(Power_SupplyControl,
	uint8_t bus_id; 	  // 0: battery, 1: motors, 2: 5V, 3: 15V, 4: 24V, 5: 48V
	uint8_t command_mask; // 000000|switching|supplying
	uint8_t command_val;  // 000000|switching|supplying
)
...
RELIABLE_PACKET(Power_ControllerState,
	uint8_t state; // 000000|sync|fault
)
...
#endif /* PROTOCOL_PROTOCOL23W24_H_ */
