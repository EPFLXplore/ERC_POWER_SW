...
void MX_FREERTOS_Init(void) {
  ...
  /* Create the thread(s) */
  /* definition and creation of systemd */
...
/* USER CODE BEGIN Header_systemd_main */
/**
  * @brief  Function implementing the systemd thread.
